...
//-----------------------------------------------------------------------------
int  sock::select_receive(char* buff, int length, int toutms)
{
    return select_receive((unsigned char*) buff, length, toutms);
}

//-----------------------------------------------------------------------------
int  sock::select_receive(unsigned char* buff, int length, int toutms)
{
...
int  udp_sock::receive(unsigned char* buff, int length, SADDR_46& rsin)
{
    ...
    {
        socklen_t iRecvLen=(socklen_t)rsin.rsz();
